...
`keiailab/keiailab-commons` 는 downstream Kubernetes operator 가 import 하는
...
본 라이브러리는 **MIT only** 정책 — *AGPL / BUSL transitive 의존성 0건*
...
4. 의존성 버전 동기화 — `go.mod` 의 `github.com/keiailab/keiailab-commons`
