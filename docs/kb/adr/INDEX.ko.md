...
> [English](INDEX.md) | **한국어** | [日本語](INDEX.ja.md) | [中文](INDEX.zh.md)

| ID | Title | Status | Date |
|----|-------|--------|------|
| [0001](0001-charter.md) | keiailab-commons charter | Accepted | 2026-05-07 |
| [0002](0002-tooling-unification-adoption.md) | Tooling unification — `.golangci.yml` + `Makefile` 도입 | Accepted | 2026-05-09 |
| [0003](0003-pkg-status-finalizer-adoption.md) | `pkg/status` 슈가 (`SetAvailable` + `SetReadyFalse`) 추가 결정 | Accepted | 2026-05-09 |
| [0004](0004-pkg-version-generic-matrix.md) | `pkg/version` 의 generic `Matrix[E]` 도입 | Accepted | 2026-05-09 |
| [0005](0005-library-chart-adoption.md) | `keiailab-commons` Helm library chart 신설 (`commonLabels` + ServiceMonitor) | Accepted | 2026-05-09 |
...
| [0012](0012-gha-block-hook.md) | GitHub Actions 차단 — lefthook pre-commit hook 자동 강제 | Accepted | 2026-05-21 |
...
| [0018](0018-keiailab-commons-rename.md) | `keiailab-commons` repository/module rename | Accepted | 2026-06-11 |
| [0019](0019-artifacthub-publish-pipeline.md) | ArtifactHub publish 파이프라인 — GHA 2-workflow narrow exception (signed OCI) | Accepted | 2026-06-12 |
