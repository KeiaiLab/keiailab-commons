...
| Helper | 용도 | RFC-0019 |
|---|---|---|
| `keiailab.commonLabels` | Helm 표준 공통 label set (Kubernetes Recommended Labels) | §3.1 |
| `keiailab.observability.serviceMonitor` | Prometheus Operator ServiceMonitor 공통 spec | §3.1 |

### 후속 PR 의 partial (별 PR)

| Helper | RFC-0019 | PR |
|---|---|---|
| `keiailab.networkpolicy.dataplane` | §3.2 | PR-B4 |
| `keiailab.networkpolicy.controlplane` | §3.2 | PR-B4 |
